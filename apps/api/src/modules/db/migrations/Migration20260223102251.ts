...
export class Migration20260223102251 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "game" ("id" uuid not null default gen_random_uuid(), "createdBy" uuid not null, "createdAt" timestamptz not null, constraint "game_pkey" primary key ("id"));`);
