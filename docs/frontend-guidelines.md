...
- Use features folder to add route components or scoped components. Look at other features in the repo. It should look like this:
  - features/
...
- Use app folder to add global components that are used in multiple features.
- Use utils folder to add utility functions.
- Use components from @codenames/ui in ./packages/ui.
- Check types, schemas and sdk from @codenames/openapi-generator in ./packages/openapi-generator.
